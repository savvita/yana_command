...
function Main(){
    ...
    const [isHiddenPicture,setHiddenPicture] = useState("hidden");
    const [isHiddenCards,setHiddenCards] = useState("");
    ...
    return(
        <div>
            ...
            <br></br>      
            <div id="form-pix" hidden={isHiddenCards}>
                    <Cards
                        pix={pix}
                    ></Cards>
            </div>  
            <div className="pictureNotFound" hidden={isHiddenPicture}>
