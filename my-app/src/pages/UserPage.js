...
function Main(params) {
    ...
    function setCache(text) {
        axios({
            method: 'get',
            url: `https://${host.getHost()}/getImagesPaginate?text=${text}&perPage=3&page=${numberOfPaage}`, //GetImagesPaginate не существует в апи ¯\_(ツ)_/¯
            headers: {
                'Accept': '*/*',
                'Content-Type': 'application/json'
            }
    ...
    return (
        <div>
            ...
            <div id="user-block">
                ...
                <img className="userAvatar" src={currentUser.avatar}></img>
